...
/**
 ...
 INTERRUPT_HANDLER(TIM2_CAP_COM_IRQHandler, 14)
 {
	 ...
	 //{
		 ...
		 //TIM2_SetCompare1(TIM2_GetCapture1() + 5000);
...
/**
 ...
 INTERRUPT_HANDLER(TIM4_UPD_OVF_IRQHandler, 23)
 {
	 ...
	 /*if(GPIO_ReadInputPin(GPIOB, GPIO_PIN_4) == RESET)
		...
		tick_ms++;
				if((key_count > 50) && (key_mode == 0))
				{
					key_flag++;
					key_count = 0;
					key_mode = 1;
				}
				else if((key_count > 1000) && (key_mode == 1))
				{
					key_flag++;
					key_count = 0;
					key_mode = 2;
				}
				else if((key_count > 100) && (key_mode == 2))
				{
						key_flag++;
						key_count = 0;
						key_mode = 2;
